...
description: Ideation agent. Discovery process — explores, challenges, discovers what user actually needs. Produces product-plan.md with vision, personas, features, business model, and agent selection.
mode: primary
