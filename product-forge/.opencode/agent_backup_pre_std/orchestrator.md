...
description: Global Orchestrator. Manages pipeline flow, invokes agents, handles human-in-the-loop. The single source of truth for pipeline execution. Works for ANY project type — dynamically selects relevant agents based on project scope.
mode: primary
